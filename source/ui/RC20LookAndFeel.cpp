...
void RC20LookAndFeel::drawRotarySlider(juce::Graphics& g, int x, int y, int w, int h,
...
void RC20LookAndFeel::drawToggleButton(juce::Graphics& g, juce::ToggleButton& button,
                                       bool, bool) {
    ...
    if (active) {
        ...
        g.fillEllipse(cx - ledR - 3.0f, cy - ledR - 3.0f,
                      (ledR + 3.0f) * 2.0f, (ledR + 3.0f) * 2.0f);
    }
...
void RC20LookAndFeel::drawComboBox(juce::Graphics& g, int w, int h, bool,
...
void RC20LookAndFeel::drawButtonBackground(juce::Graphics& g, juce::Button& button,
    ...
    else if (highlighted) fill = fill.brighter(0.1f);
