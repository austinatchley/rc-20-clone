...
void LimitModule::process(ProcessContext& ctx)
{
    ...
    switch (mode)
    {
        case Mode::Soft:   attackMs =  5.0f; releaseMs = 150.0f; kneeDb = 6.0f; break;
        case Mode::Medium: attackMs =  1.0f; releaseMs =  60.0f; kneeDb = 3.0f; break;
        case Mode::Hard:   attackMs =  0.1f; releaseMs =  20.0f; kneeDb = 0.0f; break;
        default:           attackMs =  5.0f; releaseMs = 150.0f; kneeDb = 6.0f; break;
    }
